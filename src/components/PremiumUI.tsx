...
export const DESIGN_TOKENS = {
  ...
  glass: {
    surface: "bg-white/75 dark:bg-[#0c1326]/70 backdrop-blur-2xl border border-white/60 dark:border-white/12 shadow-[0_12px_36px_rgba(0,0,0,0.06)] dark:shadow-[0_16px_40px_rgba(0,0,0,0.5)] relative overflow-hidden before:absolute before:inset-x-0 before:top-0 before:h-px before:bg-gradient-to-r before:from-transparent before:via-white/80 dark:before:via-white/20 before:to-transparent pointer-events-auto transition-all duration-300",
    surfaceElevated: "bg-white/88 dark:bg-[#111a33]/80 backdrop-blur-3xl border border-white/80 dark:border-white/18 shadow-[0_20px_50px_rgba(0,0,0,0.1)] dark:shadow-[0_24px_50px_rgba(0,0,0,0.65)] relative overflow-hidden before:absolute before:inset-x-0 before:top-0 before:h-px before:bg-gradient-to-r before:from-transparent before:via-white/90 dark:before:via-white/30 before:to-transparent pointer-events-auto transition-all duration-300",
    aiSurface: "bg-gradient-to-br from-purple-950/60 via-[#0c1326]/85 to-indigo-950/60 backdrop-blur-3xl border border-purple-400/35 dark:border-purple-400/30 shadow-[0_16px_48px_rgba(147,51,234,0.25)] relative overflow-hidden before:absolute before:inset-x-0 before:top-0 before:h-px before:bg-gradient-to-r before:from-purple-500/0 before:via-purple-300/80 before:to-purple-500/0 pointer-events-auto transition-all duration-300",
  }
};
