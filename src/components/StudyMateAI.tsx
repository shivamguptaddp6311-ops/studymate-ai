...
import { ContextMemoryChips } from "./studymate-ai/ContextMemoryChips";
  ...
  return (
    <AIErrorBoundary onReset={() => { if (onAddNotification) onAddNotification("AI Workspace Recovered", "Your workspace was restored safely.", "info"); }}>
      <div className={`flex flex-col flex-1 min-h-0 w-full bg-white/80 dark:bg-[#0c1326]/75 backdrop-blur-3xl rounded-[32px] overflow-hidden border border-white/60 dark:border-white/12 shadow-[0_20px_50px_rgba(0,0,0,0.12)] dark:shadow-[0_25px_60px_rgba(0,0,0,0.65)] relative before:absolute before:inset-x-0 before:top-0 before:h-px before:bg-gradient-to-r before:from-transparent before:via-white/80 dark:before:via-white/20 before:to-transparent ${
        ...
        {/* Context Memory Chips Above Composer */}
        <ContextMemoryChips
          chips={activeWorkspace?.contextChips}
          onRemoveChip={(chipId) => {
            const updated = workspaces.map((w) => {
              if (w.id === activeWorkspace.id) {
                return {
                  ...w,
                  contextChips: w.contextChips.filter((c) => c.id !== chipId)
                };
              }
              return w;
            });
            ...
            const updated = workspaces.map((w) => {
              if (w.id === activeWorkspace.id) {
                return {
                  ...
                  contextChips: [
                    ...w.contextChips,
                    { id: `cc-${Date.now()}`, label, type: "subject" as const }
                  ]
                };
              }
              return w;
        ...
        <div className="px-3 md:px-5 py-2 bg-white/60 dark:bg-slate-950/60 backdrop-blur-md border-t border-slate-200/50 dark:border-slate-800/60 flex items-center space-x-2 overflow-x-auto no-scrollbar shrink-0 z-20">
          ...
          <button
            ...
            className="px-3 py-1.5 bg-indigo-600 hover:bg-indigo-700 text-white border border-indigo-500 rounded-xl text-xs font-extrabold transition-all duration-150 flex items-center space-x-1.5 shrink-0 cursor-pointer shadow-xs hover:scale-[1.02] active:scale-95"
            title="Open AI Tutor Mode"
          >
            <span>🎓</span>
          ...
          <button
            type="button"
            onClick={() => setShowMistakeNotebookModal(true)}
            className="px-3 py-1.5 bg-amber-50/90 dark:bg-amber-950/50 hover:bg-amber-100 dark:hover:bg-amber-900/60 text-amber-700 dark:text-amber-300 border border-amber-200/80 dark:border-amber-800/60 rounded-xl text-xs font-bold transition-all duration-150 flex items-center space-x-1.5 shrink-0 cursor-pointer shadow-2xs hover:scale-[1.02] active:scale-95"
          ...
          <button
            ...
            className="px-3 py-1.5 bg-emerald-50/90 dark:bg-emerald-950/50 hover:bg-emerald-100 dark:hover:bg-emerald-900/60 text-emerald-700 dark:text-emerald-300 border border-emerald-200/80 dark:border-emerald-800/60 rounded-xl text-xs font-bold transition-all duration-150 flex items-center space-x-1.5 shrink-0 cursor-pointer shadow-2xs hover:scale-[1.02] active:scale-95"
          ...
          <button
            type="button"
            onClick={() => setShowFocusSessionModal(true)}
            className="px-3 py-1.5 bg-blue-50/90 dark:bg-blue-950/50 hover:bg-blue-100 dark:hover:bg-blue-900/60 text-blue-700 dark:text-blue-300 border border-blue-200/80 dark:border-blue-800/60 rounded-xl text-xs font-bold transition-all duration-150 flex items-center space-x-1.5 shrink-0 cursor-pointer shadow-2xs hover:scale-[1.02] active:scale-95"
            title="Start Focus Session Mode"
          >
            <span>⏱️</span>
          ...
          <button
            type="button"
            onClick={() => setShowFormulaEngineModal(true)}
            ...
            title="Open Formula & Concept Engine"
          >
            <span>📐</span>
          ...
          <button
            type="button"
            onClick={() => setShowProgressDashboardModal(true)}
            className="px-3 py-1.5 bg-cyan-50/90 dark:bg-cyan-950/50 hover:bg-cyan-100 dark:hover:bg-cyan-900/60 text-cyan-700 dark:text-cyan-300 border border-cyan-200/80 dark:border-cyan-800/60 rounded-xl text-xs font-bold transition-all duration-150 flex items-center space-x-1.5 shrink-0 cursor-pointer shadow-2xs hover:scale-[1.02] active:scale-95"
          ...
          <button
            ...
            className="px-3 py-1.5 bg-rose-50/90 dark:bg-rose-950/50 hover:bg-rose-100 dark:hover:bg-rose-900/60 text-rose-700 dark:text-rose-300 border border-rose-200/80 dark:border-rose-800/60 rounded-xl text-xs font-bold transition-all duration-150 flex items-center space-x-1.5 shrink-0 cursor-pointer shadow-2xs hover:scale-[1.02] active:scale-95"
          ...
          <button
            ...
            className="px-3 py-1.5 bg-indigo-500 hover:bg-indigo-600 text-white border border-indigo-400 rounded-xl text-xs font-extrabold transition-all duration-150 flex items-center space-x-1.5 shrink-0 cursor-pointer shadow-xs hover:scale-[1.02] active:scale-95"
          ...
          <button
            ...
            className="px-3 py-1.5 bg-amber-500 hover:bg-amber-600 text-slate-950 border border-amber-400 rounded-xl text-xs font-black transition-all duration-150 flex items-center space-x-1.5 shrink-0 cursor-pointer shadow-xs hover:scale-[1.02] active:scale-95"
            title="Open Live Step-by-Step Solver"
          >
            <span>⚡</span>
          ...
          <button
            type="button"
            onClick={() => setShowCollabWorkspaceModal(true)}
            className="px-3 py-1.5 bg-teal-50/90 dark:bg-teal-950/50 hover:bg-teal-100 dark:hover:bg-teal-900/60 text-teal-700 dark:text-teal-300 border border-teal-200/80 dark:border-teal-800/60 rounded-xl text-xs font-bold transition-all duration-150 flex items-center space-x-1.5 shrink-0 cursor-pointer shadow-2xs hover:scale-[1.02] active:scale-95"
            title="Open Collaborative Study Room"
          >
            <span>👥</span>
          ...
          <button
            type="button"
            onClick={() => setShowLiveLectureModal(true)}
            className="px-3 py-1.5 bg-purple-600 hover:bg-purple-700 text-white border border-purple-500 rounded-xl text-xs font-extrabold transition-all duration-150 flex items-center space-x-1.5 shrink-0 cursor-pointer shadow-xs hover:scale-[1.02] active:scale-95"
            title="Open AI Live Lecture Mode"
          >
            <span>📺</span>
          ...
          <button
            type="button"
            onClick={() => setShowUniversalSearchModal(true)}
            className="px-3 py-1.5 bg-blue-600 hover:bg-blue-700 text-white border border-blue-400 rounded-xl text-xs font-black transition-all duration-150 flex items-center space-x-1.5 shrink-0 cursor-pointer shadow-xs hover:scale-[1.02] active:scale-95"
            title="Open Universal AI Search"
          >
            <span>🔍</span>
            <span>AI Search</span>
          </button>
          ...
          <button
            ...
            className="px-3 py-1.5 bg-emerald-600 hover:bg-emerald-700 text-white border border-emerald-400 rounded-xl text-xs font-extrabold transition-all duration-150 flex items-center space-x-1.5 shrink-0 cursor-pointer shadow-xs hover:scale-[1.02] active:scale-95"
          ...
          <button
            type="button"
            onClick={() => setShowSpecializedAgentsModal(true)}
            className="px-3 py-1.5 bg-violet-600 hover:bg-violet-700 text-white border border-violet-400 rounded-xl text-xs font-black transition-all duration-150 flex items-center space-x-1.5 shrink-0 cursor-pointer shadow-xs hover:scale-[1.02] active:scale-95"
            title="Open Specialized AI Agents Mesh"
          >
            <span>🤖</span>
            <span>AI Agents</span>
          </button>
          ...
          <button
            type="button"
            onClick={() => setShowResearchModeModal(true)}
            className="px-3 py-1.5 bg-cyan-600 hover:bg-cyan-700 text-white border border-cyan-400 rounded-xl text-xs font-extrabold transition-all duration-150 flex items-center space-x-1.5 shrink-0 cursor-pointer shadow-xs hover:scale-[1.02] active:scale-95"
            title="Open Deep Research Studio"
          >
            <span>🔬</span>
          ...
          <button
            type="button"
            onClick={() => setShowExamIntelligenceModal(true)}
            className="px-3 py-1.5 bg-amber-500 hover:bg-amber-600 text-slate-950 border border-amber-300 rounded-xl text-xs font-black transition-all duration-150 flex items-center space-x-1.5 shrink-0 cursor-pointer shadow-xs hover:scale-[1.02] active:scale-95"
            title="Open Exam Intelligence & Readiness Score"
          >
            <span>🏆</span>
          ...
          <button
            type="button"
            onClick={() => setShowAdaptiveRevisionModal(true)}
            className="px-3 py-1.5 bg-teal-600 hover:bg-teal-700 text-white border border-teal-400 rounded-xl text-xs font-extrabold transition-all duration-150 flex items-center space-x-1.5 shrink-0 cursor-pointer shadow-xs hover:scale-[1.02] active:scale-95"
            title="Open Adaptive Spaced Repetition Engine"
          >
            <span>🔄</span>
          ...
          <button
            ...
            className="px-3 py-1.5 bg-pink-600 hover:bg-pink-700 text-white border border-pink-400 rounded-xl text-xs font-extrabold transition-all duration-150 flex items-center space-x-1.5 shrink-0 cursor-pointer shadow-xs hover:scale-[1.02] active:scale-95"
            title="Open Advanced Export Center"
          >
            <span>📥</span>
          ...
          <button
            ...
            className="px-3 py-1.5 bg-slate-800 hover:bg-slate-700 text-emerald-400 border border-emerald-500/50 rounded-xl text-xs font-extrabold transition-all duration-150 flex items-center space-x-1.5 shrink-0 cursor-pointer shadow-xs hover:scale-[1.02] active:scale-95"
            title="Open Offline & Cloud Sync Settings"
          >
            <span>🛡️</span>
